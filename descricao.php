...
<div class="descflex">
    ...
    <div class="desccontent">
        <div class="headcontdesc">
            <div>
                <h1>Lobinho</h1>
                <p>Cachorro | Macho | Filhote | Porte Médio</p>
            </div>
        </div>
        <div>
            <p>Está em São Paulo, São Paulo</p>
            <p>Publicado por Luís Miguel em 10/05/2025</p>
        </div>
        <div id="tdescani">
            <h3>Sobre o pet</h3>
...
<div class="descdono">
    ...
    <div class="descdonocont">
        ...
        <div>
            <h5>E-mail</h5>
            <p>lucasl1nss@gmail.com</p>
        </div>

        <button onclick="document.location='' " id="contdono">Contate o dono</button>
    </div>
